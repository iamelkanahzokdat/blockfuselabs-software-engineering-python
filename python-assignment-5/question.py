...
if command == "login":
   ...
   if user_name == users_db[0]['name'] and password == users_db[1]['password']:
      print(f"Login successful! \n{users_db}")
   elif user_name == users_db[0]['name'] and password != users_db[1]['password']:
      print(f"Wrong Password")
   elif password == users_db[0]['password'] and user_name != users_db[1]['name']:
     ...
     if user_name == users_db[0]['name']:
	     ...
	     user2 = ('name': user_name, 'password': create_password, 'balance': balance, 'is verified': False
